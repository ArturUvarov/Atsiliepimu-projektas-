            ...
            <form className="mt-8 mb-2">
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <Typography variant="small" className="font-medium">
                  <Link to="/auth/forgot-password" className="text-blue-500 hover:text-blue-700 transition-colors">
                    Forgot Password?
                  </Link>
                </Typography>
              </div>
              ...
              <Button 
                size="xl"
                className="bg-gradient-to-r from-blue-500 to-blue-700 hover:shadow-lg hover:shadow-blue-500/25 transition-all duration-300"
                fullWidth
              >
                Sign In
              </Button>
              ...
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center">
                  <Typography variant="small" className="bg-white px-4 text-blue-gray-500">
                    Or continue with
                  </Typography>
                </div>
              </div>
