            ...
            <form className="mb-2 mt-8 space-y-8" onSubmit={handleSubmit}>
              ...
              <div className="flex gap-4">
                <Button
                  size="lg"
                  variant="outlined"
                  className="flex h-8 flex-1 items-center justify-center gap-3 border-blue-gray-200 text-blue-gray-700 transition-all duration-300 hover:border-blue-500/50 hover:bg-blue-50/50 hover:text-blue-500"
                >
                  <svg
                    width="20"
                    height="20"
                ...
                <Button
                  size="lg"
                  variant="outlined"
                  className="flex flex-1 items-center justify-center gap-3 border-blue-gray-200 text-blue-gray-700 transition-all duration-300 hover:border-blue-500/50 hover:bg-blue-50/50 hover:text-blue-500"
                >
                  <svg
                    width="20"
                    height="20"
