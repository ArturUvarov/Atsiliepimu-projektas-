  ...
  return (
    <div className="relative min-h-screen w-full">
      ...
      <div className="absolute inset-0 bg-[url('/img/background-image.png')] bg-cover bg-center">
        <div className="absolute inset-0 animate-gradient-xy bg-gradient-to-br from-blue-500/10 via-white/60 to-purple-500/10 backdrop-blur-xl" />
      </div>
          ...
          <Card className="w-full max-w-lg rounded-3xl border border-white/30 bg-white/90 p-8 shadow-[0_8px_32px_rgba(0,0,0,0.1)] backdrop-blur-2xl transition-all duration-300 hover:shadow-[0_8px_48px_rgba(59,130,246,0.2)]">
            ...
            <div className="mb-12 animate-fade-in text-center">
              ...
              <Typography variant="paragraph" className="text-blue-gray-600">
                Jei norite tęsti kelionę su mumis, prisijunkite
              </Typography>
            </div>
            ...
            <form className="mb-2 mt-8 space-y-8" onSubmit={handleSubmit}>
              ...
              <div className="flex gap-4">
                <Button
                  size="lg"
                  variant="outlined"
                  className="flex h-12 flex-1 items-center justify-center gap-3 border-blue-gray-200 text-blue-gray-700 transition-all duration-300 hover:border-blue-500/50 hover:bg-blue-50/50 hover:text-blue-500"
                >
                  <svg
                    width="24"
                    height="24"
